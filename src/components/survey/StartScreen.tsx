  ...
  return <div className="max-w-md mx-auto">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-6">
        <p className="text-center text-lg mb-4">
          Get a <span className="text-blue-800 font-semibold">Best Buy Gift Card</span> with our Review Program. Simply answer 3 short questions about your shopping experiences and this fantastic opportunity is yours!
        </p>
